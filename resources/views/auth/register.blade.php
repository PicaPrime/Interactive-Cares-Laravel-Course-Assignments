    ...
    @section('content')
        ...
        <main class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div class="auth-container max-w-md w-full space-y-6 p-10 bg-white rounded-xl shadow-lg">
                ...
                <!-- Signup Form -->
                <form class="mt-6 space-y-5" action="{{ route('auth.register') }}" method="POST" id="signupForm">
                    <!-- Name Input -->
                    @if ($errors->any())
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500" id="emailHelp">We'll never share your email with anyone else.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500" id="passwordHelp">Use 8 or more characters with a mix of
                            letters, numbers & symbols.</p>
                    </div>
